...
void ConsoleApp::_add_hidden_command(Function p_function, const String& p_name) {
    Command command;
...
void ConsoleApp::_add_simple_command(Function p_function, const String& p_name, const String& p_description) {
    Command command;
...
void ConsoleApp::_add_prompt_command(Function p_function, const String& p_name, const String& p_description, const String& p_prompt) {
    Command command;
...
void ConsoleApp::_set_log_file_name() {
    if (input == "default") {
...
void ConsoleApp::_to_config_file(ConfigFile& p_file) const {
#ifdef LOG_ENABLED
...
void ConsoleApp::_from_config_file(const ConfigFile& p_file) {
#ifdef LOG_ENABLED
...
Error ConsoleApp::_save(const String& p_path) {
...
Error ConsoleApp::_load(const String& p_path) {
    ConfigFile config_file;
#ifndef CONFIG_FILE_ENCRYPTION_ENABLED
...
ConsoleApp::ConsoleApp() :
    ...
    _add_prompt_command(&ConsoleApp::_set_read_path, "read_path", "Change the path that you would like to read from", "Type the path (or 'current' to use the current directory):");
    _add_prompt_command(&ConsoleApp::_set_write_path, "write_path", "Change the path that you would like to write to", "Type the path:");
    _add_prompt_command(&ConsoleApp::_add_extension, "add_extension", "Add an extension to the extension list", "Type the extension to add:");
    _add_prompt_command(&ConsoleApp::_remove_extension, "remove_extension", "Remove an extension from the extension list", "Type the extension to remove:");
    _add_simple_command(&ConsoleApp::_clear_extensions, "clear_extensions", "Clear all of the extensions in the extension list");
    _add_prompt_command(&ConsoleApp::_set_pack_mode, "pack_mode", "Pack matching extensions, exclude matching extensions or pack everything", "Type '" + Packer::get_pack_mode_name(Packer::PackMode::Include) + "', '" + Packer::get_pack_mode_name(Packer::PackMode::Exclude) + "', '" + Packer::get_pack_mode_name(Packer::PackMode::Everything) + ":");
    _add_simple_command(&ConsoleApp::_set_overwrite_files, "overwrite_files", "Overwrite existing files");
    _add_simple_command(&ConsoleApp::_set_move_files, "move_files", "Move the files");
    _add_prompt_command(&ConsoleApp::_set_suffix_string, "suffix_string", "The suffix string to remove", "Type the suffix string to remove:");
    _add_simple_command(&ConsoleApp::_set_suffix_enabled, "suffix_enabled", "Enable suffix string removal");
    _add_simple_command(&ConsoleApp::_set_extension_insensitive, "extension_insensitive", "Ignore extension case in the extension list");
    _add_prompt_command(&ConsoleApp::_set_extension_adjust, "extension_adjust", "Adjust the extension case", "Type '" + Packer::get_extension_adjust_name(Packer::ExtensionAdjust::Default) + "', '" + Packer::get_extension_adjust_name(Packer::ExtensionAdjust::Lower) + "', '" + Packer::get_extension_adjust_name(Packer::ExtensionAdjust::Upper) + ":");
#ifdef IGNORE_FILE_ENABLED
    _add_prompt_command(&ConsoleApp::_set_ignore_file_name, "ignore_file_name", "Change the name of the ignore file", "Type the name of the ignore file (or 'default' to use to the default):");
    _add_simple_command(&ConsoleApp::_set_ignore_file_enabled, "ignore_file_enabled", "Check for an ignore file");
#endif // IGNORE_FILE_ENABLED
#ifdef LOG_ENABLED
    _add_prompt_command(&ConsoleApp::_set_log_file_name, "log_file_name", "Change the name of the log file", "Type the name of the log file (or 'default' to use the default):");
    _add_simple_command(&ConsoleApp::_set_log_enabled, "log_enabled", "Enable logging");
#endif // LOG_ENABLED
    _add_simple_command(&ConsoleApp::_swap_paths, "swap_paths", "Swap the read and write directories");
    _add_simple_command(&ConsoleApp::_revert_state, "revert", "Revert all of the settings to their defaults");
    _add_prompt_command(&ConsoleApp::_save_config, "save", "Save the state to a config file", "Type the name of the config file (or 'default' to use the default):");
    _add_prompt_command(&ConsoleApp::_load_config, "load", "Load a state from a config file", "Type the name of the config file (or 'default' to use the default):");
    _add_simple_command(&ConsoleApp::_print_info, "info", "Print the current state of the packer");
    _add_simple_command(&ConsoleApp::_run_packer, "run", "Run the packer");
    _add_simple_command(&ConsoleApp::_quit_program, "quit", "Quit the application");
    _add_hidden_command(&ConsoleApp::_print_help, "help");
}
